...
Plot4_content <- function(dfHPC){
  ## create device-independent output for plot 4
  
  par(mfrow=c(2,2))
  
    ## subplot [1,1]
  with(dfHPC, plot(DateTime, Global_active_power, type="l", xlab="", ylab = "Global Active Power"))
  
  ## subplot [1,2]
  with(dfHPC, plot(DateTime, Voltage, type="l", xlab="datetime", ylab = "Voltage"))  
  ...
  ## subplot [2,2]
  with(dfHPC, plot(DateTime, Global_reactive_power, type="l", xlab="datetime"))
}
